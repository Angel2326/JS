...
const game = {
    ...
    reset() {
        ...
        this.barrier.setCoordinates(this.getRandomFreeCoordinates(this.barrier));
    ...
    getRandomFreeCoordinates(obj) {
        const exclude = [obj.getCoordinates(), ...this.snake.getBody()];
    ...
    canMakeStep() {
        ...
        return !this.snake.isOnPoint(nextHeadPoint) &&
            ...
            nextHeadPoint.x >= 0 &&
            nextHeadPoint.y >= 0 &&
            (nextHeadPoint.x != this.barrier.x || nextHeadPoint.y != this.barrier.y);
        //= (nextHeadPoint != this.barrier.x || nextHeadPoint != this.barrier.y);
    },
    ...
    RenderGameScore() {
        let GameScoreInfo = document.getElementById("scoregame");
        GameScoreInfo.textContent = "Количество съеденных элементов: " + this.gameScore() + " шт";
    },
